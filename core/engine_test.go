...
// stubProactiveMediaPlatform is a media platform that can also rebuild a reply
// context from a session key — equivalent to what Slack/Telegram/etc. provide
// in production via core.ReplyContextReconstructor.
